/**
 *  CollectionInterfaceTestcase ViewModel Class
 */
 ...
 * @extends ViewModel
 */
class CollectionInterfaceTestcase extends require('./ViewModel') {
  /**
   * Create a View Model
   *
   ...
   */
  getModel() {
    return require('../db/CollectionInterfaceTestcase');
  }
}

// export CollectionInterfaceTestcase class
