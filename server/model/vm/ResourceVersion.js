 ...
 * @extends ViewModel
 */
class ResouceVersion extends require('./ViewModel') {
  /**
   * Create a View Model
   *
   ...
   */
  getModel() {
    return require('../db/ResourceVersion');
  }
}

// export Clients class
module.exports = ResouceVersion;
