...
;( function( window ) {
	...
	BookBlock.prototype = {
		...
		_init : function() {
			...
			this.currentIdx = this.options.currentIdx || 0;
		...
		_addSide : function( side, dir ) {
			...
			switch (side) {
				case 'left':
					...
					var inner = dir === 'next' ? this.current.querySelector("div").cloneNode(true) : this.nextItem.querySelector("div").cloneNode(true);
					sideEl.innerHTML = '<div class="bb-back"><div class="bb-outer"><div class="bb-content"><div class="bb-inner"></div></div><div class="bb-overlay"></div></div></div>';
					sideEl.querySelector("div.bb-inner").appendChild(inner);
					break;
				case 'middle':
						/*
					...
					var frontinner = dir === 'next' ? this.current.querySelector("div").cloneNode(true) : this.nextItem.querySelector("div").cloneNode(true);
					var backinner = dir === 'next' ? this.nextItem.querySelector("div").cloneNode(true) : this.current.querySelector("div").cloneNode(true); 
					sideEl.innerHTML = '<div class="bb-front"><div class="bb-outer"><div class="bb-content"><div class="bb-inner"></div></div><div class="bb-flipoverlay"></div></div></div><div class="bb-back"><div class="bb-outer"><div class="bb-content" style="width:' + this.elWidth + 'px"><div class="bb-inner"></div></div><div class="bb-flipoverlay"></div></div></div>';
					sideEl.querySelectorAll("div.bb-inner")[0].appendChild(frontinner);
					sideEl.querySelectorAll("div.bb-inner")[1].appendChild(backinner);
					break;
				case 'right':
						/*
					...
					var inner = dir === 'next' ? this.nextItem.querySelector("div").cloneNode(true) : this.current.querySelector("div").cloneNode(true);
					sideEl.innerHTML = '<div class="bb-front"><div class="bb-outer"><div class="bb-content"><div class="bb-inner"></div></div><div class="bb-overlay"></div></div></div>';
					sideEl.querySelector("div.bb-inner").appendChild(inner);
					break;
			}
