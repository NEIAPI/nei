NEJ.define([
  ...
  _pro.__doBuild = function () {
    ...
    this.__listOpt = {
      ...
      listCacheKey: _ncache._$cacheKeyApi,
      queryData: {
        type: db.MSG_TYP_API,
        limit: 20,
        offset: 0,
      ...
      batchAction: (function () {
        return '<a class="batch-action-item" data-action=\'{"type": "read","keyType":"api"}\'>标记确认</a>' +
          '<a class="batch-action-item" data-action=\'{"type": "read","keyType":"api","isAll":true}\'>全部标记确认</a>';
      })(),
      noItemTip: '暂无数据',
