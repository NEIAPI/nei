NEJ.define([
  ...
  _p._$$ModuleDatatypeDetailVersion = _k._$klass();
  _pro = _p._$$ModuleDatatypeDetailVersion._$extend(resVersion._$$ModuleResVersion);

  _pro.__doBuild = function () {
    this.__body = _e._$html2node(
      _l._$getTextTemplate('module-datatype-detail-version')
    );
    ...
    var stripedListOption = {
      ...
      filter: function (list, xlistState) {
        ...
        list.forEach(function (item) {
          ...
          itemState['__ui_name'] = '<a href="/datatype/detail' + linkSuffix + '" class="stateful">' + escapeName + '</a>';
  ...
  _m._$regist(
    ...
    _p._$$ModuleDatatypeDetailVersion
  );
});
